...
func void B_GiveNpcTalents(var C_Npc slf)
{
	...
	Npc_SetTalentSkill(slf,NPC_TALENT_ARMOR,0);
	Npc_SetTalentSkill(slf,NPC_TALENT_OREMASTER,0);
	Npc_SetTalentSkill(slf,NPC_TALENT_WOODMASTER,0);
	Npc_SetTalentSkill(slf,NPC_TALENT_RUNES,1);
	Npc_SetTalentSkill(slf,NPC_TALENT_LEATHER,0);
