...
{
	TA_Stand_Guarding(8,0,20,5,"NW_CITY_HABOUR_02_B");
	ta_sit_table(20,5,22,15,"NW_CITY_MERCHANT_TAVERN01_IN");
	TA_Stand_Guarding(22,15,8,0,"NW_CITY_HABOUR_02_B");
};

func void Rtn_Start_449()
{
	TA_Stand_Guarding(4,35,17,5,"NW_CITY_HABOUR_02_B");
	TA_Sit_Bench(17,5,18,5,"NW_CITY_HABOUR_06_ADD7");
	TA_Stand_Guarding(18,5,20,5,"NW_CITY_HABOUR_06_ADD6");
	ta_sit_table(20,5,0,15,"NW_CITY_MERCHANT_TAVERN01_IN");
	TA_Sit_Chair(0,15,4,35,"NW_CITY_HABOUR_TAVERN01_06");
};
