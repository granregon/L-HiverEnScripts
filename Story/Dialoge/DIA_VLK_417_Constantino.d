...
func void DIA_Constantino_TEACH_Info()
{
	...
	{
		Info_AddChoice(DIA_Constantino_TEACH,B_BuildLearnString("Healing potion enchancer",B_GetLearnCostTalent(other,NPC_TALENT_ALCHEMY,POTION_CONST_HEAL)),dia_constantino_teach_potion_const_heal);
	};
	...
	{
		Info_AddChoice(DIA_Constantino_TEACH,B_BuildLearnString("Mana potion enchancer",B_GetLearnCostTalent(other,NPC_TALENT_ALCHEMY,POTION_CONST_MANA)),dia_constantino_teach_potion_const_mana);
	};
