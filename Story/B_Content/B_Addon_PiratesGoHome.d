...
{
	if((Npc_GetDistToWP(hero,"ADW_CANYON_MINE1_09") < 3000) || (Npc_GetDistToWP(hero,"ADW_CANYON_MINE2_04") < 2000) || (Npc_GetDistToWP(hero,"ADW_CANYON_LIBRARY_04") < 3500) || (Npc_GetDistToWP(hero,"ADW_CANYON_PATH_TO_BANDITS_30") < 1500) || (Npc_GetDistToWP(hero,"ADW_ENTRANCE_2_PIRATECAMP_13") < 2500) || (Npc_GetDistToWP(hero,"ADW_ENTRANCE_2_PIRATECAMP_14") < 1500) || (Npc_GetDistToWP(hero,"ADW_CANYON_PATH_TO_BANDITS_25") < 6000) || (Npc_GetDistToWP(hero,"ADW_PIRATECAMP_WAY_16") < 8000))
	{
		return TRUE;
	};
	return FALSE;
