...
func void b_kdw_hood(var C_Npc self)
{
	var C_Item magrobe;
	magrobe = Npc_GetEquippedArmor(self);
	if(Hlp_IsItem(magrobe,itar_kdw_h) == TRUE)
	{
		Npc_RemoveInvItems(self,itar_kdw_h,1);
		CreateInvItems(self,itar_kdw_h_wh,1);
		AI_EquipArmor(self,itar_kdw_h_wh);
	};
	if(Hlp_IsItem(magrobe,itar_kdw_h_wh) == TRUE)
	{
		Npc_RemoveInvItems(self,itar_kdw_h_wh,1);
		CreateInvItems(self,itar_kdw_h,1);
		AI_EquipArmor(self,itar_kdw_h);
	};
};
