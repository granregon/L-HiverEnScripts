...
class C_SVM
{
	...
	var string bezi_to_wie;
	var string bezi_nic_ciekawego;
	var string bezi_nieciekawe;
	var string bezi_interes;
	var string bezi_skladniki;
	var string bezi_innos;
	var string bezi_beliar;
	var string bezi_blogo;
	var string bezi_maszzloto;
	var string bezi_ofiara;
	var string bezi_runa;
	var string bezi_miecz;
	var string bezi_kowal;
	var string bezi_gotowy;
...
instance SVM_15(C_SVM)
{
	...
	bezi_to_wie = "SVM_PLAYER_NOTHINGNEW_01_POLISH";	//I already know that.
	bezi_nic_ciekawego = "SVM_PLAYER_NOTHINGNEW_00_POLISH";	//There's nothing new here.
	bezi_nieciekawe = "SVM_PLAYER_NOTHINGNEW_02_POLISH";	//Uninteresting.
	bezi_interes = "SVM_PLAYER_FOUNDSOMETHING_02_POLISH";	//Interesting.
	bezi_skladniki = "SVM_PLAYER_MISSINGINGREDIENTS_POLISH";	//I don't have the ingredients for that.
	bezi_innos = "SVM_PLAYER_INNOS_POLISH";	//Innos.
	bezi_beliar = "SVM_PLAYER_BELIAR_POLISH";	//Beliar.
	bezi_blogo = "SVM_PLAYER_INNOSOTHER_POLISH";	//Grant me the power of your blessing.
	bezi_maszzloto = "SVM_PLAYER_SACRIFICE_00_POLISH";	//Accept my gold as a sacrifice.
	bezi_ofiara = "SVM_PLAYER_SACRIFICE_02_POLISH";	//Here's the sacrifice which you demand.
	bezi_runa = "SVM_PLAYER_BELIAROTHER_POLISH";	//Grant me power of a spirit and body.
	bezi_miecz = "SVM_PLAYER_BELIARCOMBAT_POLISH";	//Grant me power of death and destruction.
	bezi_kowal = "SVM_PLAYER_SMITHBOOK_POLISH";	//Here's something about the art of forging.
	bezi_gotowy = "SVM_PLAYER_NOTREADYYET_POLISH";	//I am not ready for that.
