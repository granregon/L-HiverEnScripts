...
func int b_teachplayertalentenchanting(var C_Npc slf,var C_Npc oth,var int enchantmastery)
{
	...
	if(enchantmastery == ENCHANTMASTERY_0)
	{
		...
		B_LogEntry(TOPIC_TALENTENCHANTING,LOGTEXT_ENCH_NOVICE17);
		B_LogEntry(TOPIC_TALENTENCHANTING,LOGTEXT_ENCH_NOVICE18);
		B_LogEntry(TOPIC_TALENTENCHANTING,LOGTEXT_ENCH_NOVICE19);
	...
	if(enchantmastery == ENCHANTMASTERY_1)
	{
		...
		B_LogEntry(TOPIC_TALENTENCHANTING,LOGTEXT_ENCH_WIZARD17);
		B_LogEntry(TOPIC_TALENTENCHANTING,LOGTEXT_ENCH_WIZARD18);
		B_LogEntry(TOPIC_TALENTENCHANTING,LOGTEXT_ENCH_WIZARD19);
	...
	if(enchantmastery == ENCHANTMASTERY_2)
	{
		...
		B_LogEntry(TOPIC_TALENTENCHANTING,LOGTEXT_ENCH_MWIZARD17);
		B_LogEntry(TOPIC_TALENTENCHANTING,LOGTEXT_ENCH_MWIZARD18);
		B_LogEntry(TOPIC_TALENTENCHANTING,LOGTEXT_ENCH_MWIZARD19);
