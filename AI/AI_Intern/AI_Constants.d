...
const int AIV_HEAVYARMOR = 90;
const int AIV_SH_EQUIP = 91;
const int AIV_SH_UNEQUIP = 92;
const int SH_TRUE = 0;
const int SH_FALSE = 1;
...
const int FIGHT_DIST_DRAGON_MAGIC = 650;
...
const int MOBSI_MAKEBOWS = 16;
const int MOBSI_WOODSAW = 17;
const int MOBSI_ENCHANT = 18;
