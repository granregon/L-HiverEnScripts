...
const string MOB_SIT = "BARON,BENCH,CHAIR,GROUND,TABLE1,TABLE2,TABLE3,THRONE,CAMPFIRE,KLAVIER";
const string MOB_LIE = "BED,BEDHIGH,BEDLOW,BATHTUB";
const string MOB_CLIMB = "CLIMB,LADDER,RANKE";
const string MOB_NOTINTERRUPTABLE = "DOOR,GATE,LEVER,TOUCHPLATE,TURNSWITCH,VWHEEL,BASKET,CUPBOARDSMALLUP,CHESTBIG,CHESTSMALL,CUPBOARD,CUPBOARD2,DRESSER,WARDROBE,HERB,IDOL,PAN,SMOKE,INNOS";
