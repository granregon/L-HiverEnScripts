...
func void ta_sit_table(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_sit_table,waypoint);
};
...
func void ta_sit_baron(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_sit_baron,waypoint);
};

func void ta_campfire_fry(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_campfire_fry,waypoint);
};

func void ta_bathtub(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_bathtub,waypoint);
};

func void ta_piano(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_piano,waypoint);
};
...
func void ta_smith_wbench(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_smith_wbench,waypoint);
};
...
func void ta_wash_self(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_wash_self,waypoint);
};
