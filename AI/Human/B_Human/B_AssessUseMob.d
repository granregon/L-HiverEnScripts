...
func void B_AssessUseMob()
{
	...
	if((Hlp_StrCmp(detMob,"CHESTBIG") == FALSE) && (Hlp_StrCmp(detMob,"CHESTSMALL") == FALSE) && (Hlp_StrCmp(detMob,"BASKET") == FALSE) && (Hlp_StrCmp(detMob,"CUPBOARDSMALLUP") == FALSE) && (Hlp_StrCmp(detMob,"CUPBOARD") == FALSE) && (Hlp_StrCmp(detMob,"CUPBOARD2") == FALSE) && (Hlp_StrCmp(detMob,"DRESSER") == FALSE) && (Hlp_StrCmp(detMob,"WARDROBE") == FALSE))
	{
		return;
	};
