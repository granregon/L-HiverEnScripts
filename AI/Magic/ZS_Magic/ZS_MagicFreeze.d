...
{
	if((Npc_GetStateTime(self) > SPL_TIME_FREEZE) || (((self.guild == GIL_DRAGON) || (self.aivar[AIV_MM_REAL_ID] == ID_RAVEN) || (self.aivar[AIV_MM_REAL_ID] == ID_AMORT)) && (Npc_GetStateTime(self) > (SPL_TIME_FREEZE / 3))))
	{
		B_StopMagicFreeze();
		return LOOP_END;
	};
