...
instance ItRu_PalLight(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_10;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_PalLightHeal(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_50;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_PalMediumHeal(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_100;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_PalFullHeal(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_150;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_PalTeleportSecret(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_550;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_FireBolt(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_05;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_Zap(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_07;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_InstantFireball(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_15;
	text[5] = NAME_1KG;
	count[5] = value;
};

instance ITRU_DRAGONFIREBALL(C_Item)
{
	name = NAME_Rune;
	mainflag = ITEM_KAT_RUNE;
	flags = 0;
	...
	material = MAT_STONE;
	mag_circle = 2;
	spell = SPL_DRAGONFIREBALL;
	text[3] = NAME_MAGIC_EXHAUSTION_ZERO;
};
...
instance ItRu_Windfist(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_WF;
...
instance ItRu_Sleep(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_45;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_LightningFlash(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_30;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_ChargeFireball(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_CFB;
...
instance ItRu_SumSkel(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_200;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_ThunderBall(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_CZ;
...
instance ItRu_SumGol(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_250;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_Pyrokinesis(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_PYROS;
...
instance ItRu_Firestorm(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_35;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_IceWave(C_Item)
{
	...
	text[2] = NAME_Damage;
	count[2] = 60;
	text[3] = NAME_MAGIC_EXHAUSTION_300;
	text[4] = NAME_DAM_MAGICIC;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_Firerain(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_750;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_BreathOfDeath(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_120;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_MassDeath(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_900;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_MasterOfDisaster(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_80;
	text[5] = NAME_1KG;
	count[5] = value;
};
...
instance ItRu_ArmyOfDarkness(C_Item)
{
	...
	text[3] = NAME_MAGIC_EXHAUSTION_650;
	text[5] = NAME_1KG;
	count[5] = value;
};
