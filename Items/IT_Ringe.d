...
func void Equip_ItRi_Prot_Edge_02()
{
	...
	STAT_SWORDDEF = STAT_SWORDDEF + (Ri_ProtEdge02 * 1);
	Npc_SetTalentSkill(hero,NPC_TALENT_SWORDDEF,STAT_SWORDDEF);
};
...
instance ItRi_Prot_Total_01(C_Item)
{
	...
	count[1] = Ri_TProtFire;
	text[2] = NAME_Prot_Point;
	count[2] = Ri_TProtPoint;
	text[3] = NAME_Prot_Edge;
	count[3] = Ri_TProtEdge;
	text[4] = NAME_PROT_BLUNT;
...
func void Equip_ItRi_Prot_Total_01()
{
	...
	STAT_SWORDDEF = STAT_SWORDDEF + (Ri_TProtEdge * 1);
	Npc_SetTalentSkill(hero,NPC_TALENT_SWORDDEF,STAT_SWORDDEF);
};
...
instance ItRi_Prot_Total_02(C_Item)
{
	...
	text[1] = NAME_Prot_Fire;
	count[1] = Ri_TProtFire02;
	text[2] = NAME_Prot_Point;
	count[2] = Ri_TProtPoint02;
	text[3] = NAME_Prot_Edge;
	count[3] = Ri_TProtEdge02;
	text[4] = NAME_PROT_BLUNT;
...
func void Equip_ItRi_Prot_Total_02()
{
	...
	STAT_SWORDDEF = STAT_SWORDDEF + (Ri_TProtEdge02 * 1);
	Npc_SetTalentSkill(hero,NPC_TALENT_SWORDDEF,STAT_SWORDDEF);
};
