...
const int XP_Addon_Cavalorn_Letter2Vatras_Opened = 100;
...
const int XP_Addon_VatrasStonplate = 50;
const int XP_Addon_FarimSchutz = 100;
...
const int XP_Addon_BeliarsWeaponAbgegeben = 15000;
...
const int XP_Attila_MetHim = 100;
...
const int XP_RamirezSextant = 250;
const int XP_JesperTruhe = 150;
const int XP_Thekla_BlameSylvio = 100;
const int XP_BronkoGehtAnDieArbeit = 100;
...
const int XP_KickBullco = 150;
const int XP_PepeWolves = 200;
