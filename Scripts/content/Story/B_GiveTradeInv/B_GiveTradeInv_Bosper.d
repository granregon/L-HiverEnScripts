...
func void B_GiveTradeInv_Bosper(var C_Npc slf)
{
	if((Kapitel >= 1) && (Bosper_ItemsGiven_Chapter_1 == FALSE))
	{
		...
		CreateInvItems(slf,itmi_leather,6);
		CreateInvItems(slf,itmi_woodbar,2);
		CreateInvItems(slf,itwr_addon_tacrft_01,1);
		...
		CreateInvItems(slf,itri_addon_enchbows_01,1);
	...
	{
		CreateInvItems(slf,ItMi_Gold,100);
		CreateInvItems(slf,itmi_leather,4);
		CreateInvItems(slf,itmi_woodbar,2);
