...
{
	if((PLAYER_MOBSI_PRODUCTION == MOBSI_PotionAlchemy) && (ManaStart == FALSE) && (BoozeStart == FALSE) && (TabakStart == FALSE) && (HealthStart == FALSE) && (SpecialStart == FALSE) && (CONSTANTINSTART == FALSE) && ((KNOWS_EXHAUS_01 == TRUE) || (KNOWS_EXHAUS_02 == TRUE) || (KNOWS_EXHAUS_03 == TRUE) || (PLAYER_TALENT_ALCHEMY[15] == TRUE) || (PLAYER_TALENT_ALCHEMY[16] == TRUE)))
	{
		return TRUE;
	};
};
...
instance PC_ITPO_EXHAUS_CRFT_01(C_Info)
{
	nr = 1;
	npc = PC_Hero;
	condition = pc_itpo_exhaus_crft_01_condition;
	information = pc_itpo_exhaus_crft_01_info;
	permanent = TRUE;
	description = "Essence of spirit recovery (2 dark mushroom, 1 digger's meat, 1 blue elder)";
};


func int pc_itpo_exhaus_crft_01_condition()
{
	if((PLAYER_MOBSI_PRODUCTION == MOBSI_PotionAlchemy) && (KNOWS_EXHAUS_01 == TRUE) && (CONSTANTINSTART == TRUE))
	{
		return TRUE;
	};
};

func void pc_itpo_exhaus_crft_01_info()
{
	if((Npc_HasItems(hero,ItPl_Mushroom_01) >= 2) && (Npc_HasItems(hero,ItPl_Mushroom_02) >= 1) && (Npc_HasItems(hero,ItPl_Blueplant) >= 1))
	{
		...
		CreateInvItems(hero,itpo_exhaus_01,1);
		Print(PRINT_AlchemySuccess);
	}
	else
	{
...
instance PC_ITPO_EXHAUS_CRFT_02(C_Info)
{
	nr = 2;
	npc = PC_Hero;
	condition = pc_itpo_exhaus_crft_02_condition;
	information = pc_itpo_exhaus_crft_02_info;
	permanent = TRUE;
	description = "Extract of spirit recovery (3 dark mushroom, 1 digger's meat, 2 blue elder)";
};


func int pc_itpo_exhaus_crft_02_condition()
{
	if((PLAYER_MOBSI_PRODUCTION == MOBSI_PotionAlchemy) && (KNOWS_EXHAUS_02 == TRUE) && (CONSTANTINSTART == TRUE))
	{
		return TRUE;
	};
};

func void pc_itpo_exhaus_crft_02_info()
{
	if((Npc_HasItems(hero,ItPl_Mushroom_01) >= 3) && (Npc_HasItems(hero,ItPl_Mushroom_02) >= 1) && (Npc_HasItems(hero,ItPl_Blueplant) >= 2))
	{
		Npc_RemoveInvItems(hero,ItPl_Mushroom_01,3);
		Npc_RemoveInvItems(hero,ItPl_Mushroom_02,1);
		Npc_RemoveInvItems(hero,ItPl_Blueplant,2);
		CreateInvItems(hero,itpo_exhaus_02,1);
		Print(PRINT_AlchemySuccess);
	}
	else
	{
...
instance PC_ITPO_EXHAUS_CRFT_03(C_Info)
{
	nr = 3;
	npc = PC_Hero;
	condition = pc_itpo_exhaus_crft_03_condition;
	information = pc_itpo_exhaus_crft_03_info;
	permanent = TRUE;
	description = "Elixir of spirit recovery (4 dark mushroom, 2 digger's meat, 3 blue elder)";
};


func int pc_itpo_exhaus_crft_03_condition()
{
	if((PLAYER_MOBSI_PRODUCTION == MOBSI_PotionAlchemy) && (KNOWS_EXHAUS_03 == TRUE) && (CONSTANTINSTART == TRUE))
	{
		return TRUE;
	};
};

func void pc_itpo_exhaus_crft_03_info()
{
	if((Npc_HasItems(hero,ItPl_Mushroom_01) >= 4) && (Npc_HasItems(hero,ItPl_Mushroom_02) >= 2) && (Npc_HasItems(hero,ItPl_Blueplant) >= 3))
	{
		Npc_RemoveInvItems(hero,ItPl_Mushroom_01,4);
		Npc_RemoveInvItems(hero,ItPl_Mushroom_02,2);
		Npc_RemoveInvItems(hero,ItPl_Blueplant,3);
		CreateInvItems(hero,itpo_exhaus_03,1);
		Print(PRINT_AlchemySuccess);
	}
	else
	{
