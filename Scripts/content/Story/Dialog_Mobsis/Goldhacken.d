...
func void PC_Goldhacken_Addon_Chance_Info()
{
	...
	{
		concatText = ConcatStrings("Bloody beginner (",IntToString(Hero_HackChance));
	}
	...
	{
		concatText = ConcatStrings("Experienced goldscraper (",IntToString(Hero_HackChance));
	}
	...
	{
		concatText = ConcatStrings("Digger guru ( ",IntToString(Hero_HackChance));
	};
