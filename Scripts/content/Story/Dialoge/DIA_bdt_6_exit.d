...
{
	AI_Output(self,other,"SVM_6_GetOutOfHere");	//Get out of here!
};
...
func void dia_bdt_6_standard_info()
{
	...
	if(randy == 0)
	{
		AI_Output(self,other,"SVM_6_WhatsThisSupposedToBe");	//What are you up to? What's all this creeping about?
	};
	if(randy == 1)
	{
	...
	if(randy == 2)
	{
		AI_Output(self,other,"SVM_6_NOTNOW");	//Leave me alone!
	};
	AI_StopProcessInfos(self);
};
