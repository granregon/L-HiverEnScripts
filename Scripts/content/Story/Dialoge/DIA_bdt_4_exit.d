...
{
	AI_Output(self,other,"SVM_4_GetOutOfHere");	//Out!
};
...
func void dia_bdt_4_standard_info()
{
	...
	if(randy == 0)
	{
		AI_Output(self,other,"SVM_4_WhatsThisSupposedToBe");	//What are you creeping around there for?
	};
	if(randy == 1)
	{
	...
	if(randy == 2)
	{
		AI_Output(self,other,"SVM_4_NOTNOW");	//Leave me alone!
	};
	AI_StopProcessInfos(self);
};
