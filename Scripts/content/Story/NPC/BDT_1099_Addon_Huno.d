...
{
	ta_wash_self(6,0,6,15,"BL_SMITH_YARD_02");
	TA_Smith_Anvil(6,15,6,45,"BL_UP_02");
	TA_Smith_Sharp(6,45,7,15,"BL_SMITH_YARD_02");
	ta_wash_self(7,15,7,30,"BL_SMITH_YARD_02");
	TA_Smith_Anvil(7,30,8,0,"BL_UP_02");
	TA_Smith_Sharp(8,0,8,30,"BL_SMITH_YARD_02");
	ta_wash_self(8,30,9,0,"BL_SMITH_YARD_02");
	TA_Smith_Anvil(9,0,10,0,"BL_UP_02");
	TA_Smith_Sharp(10,0,11,0,"BL_SMITH_YARD_02");
	ta_wash_self(11,0,11,30,"BL_SMITH_YARD_02");
	TA_Smith_Anvil(11,30,12,30,"BL_UP_02");
	TA_Smith_Sharp(12,30,13,30,"BL_SMITH_YARD_02");
	ta_wash_self(13,30,14,0,"BL_SMITH_YARD_02");
	TA_Smith_Sharp(14,0,16,0,"BL_SMITH_YARD_02");
	ta_wash_self(16,0,16,30,"BL_SMITH_YARD_02");
	TA_Smith_Anvil(16,30,17,30,"BL_UP_02");
	TA_Smith_Sharp(17,30,18,30,"BL_SMITH_YARD_02");
	ta_wash_self(18,30,19,0,"BL_SMITH_YARD_02");
	TA_Smith_Anvil(19,0,20,0,"BL_UP_02");
	TA_Smith_Sharp(20,0,21,0,"BL_SMITH_YARD_02");
	ta_wash_self(21,0,21,30,"BL_SMITH_YARD_02");
	TA_Sit_Bench(21,30,23,30,"BL_SMITH_BENCH_01");
	TA_Sleep(23,30,6,0,"BL_SMITH_SLEEP");
};
