...
instance ITWR_EXHAUS_01(C_Item)
{
	name = "Recipe for the Essence of spirit recovery";
	mainflag = ITEM_KAT_DOCS;
	flags = 0;
	value = 800;
	visual = "ItWr_Scroll_01_v4.3DS";
	material = MAT_LEATHER;
	on_state[0] = use_rezept_exhaus_01;
	scemeName = "MAP";
	description = name;
	text[5] = NAME_Value;
	count[5] = value;
...
func void use_rezept_exhaus_01()
{
	var int nDocID;
	if(Npc_IsPlayer(self))
	{
		if((PLAYER_TALENT_ALCHEMY[POTION_Mana_03] == TRUE) && (KNOWS_EXHAUS_01 == FALSE))
		{
			KNOWS_EXHAUS_01 = TRUE;
			Snd_Play("LevelUP");
			B_LogEntry(TOPIC_TalentAlchemy,"To prepare the Essence of spirit recovery, you need 2 black mushrooms,a miner's meat and a blue elder.");
		}
		else if(KNOWS_EXHAUS_01 == TRUE)
		{
			B_Say(hero,hero,"$BEZI_TO_WIE");
		}
		else
	...
	Doc_SetMargins(nDocID,-1,50,50,75,50,1);
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"   Creating");
	Doc_PrintLine(nDocID,0,"       the Essence of spirit recovery");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"        x2 Black mushrooms");
	Doc_PrintLine(nDocID,0,"        x1 Digger's meat");
	Doc_PrintLine(nDocID,0,"        x1 Blue elder");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0," This potion can only be created by an alchemist");
	Doc_PrintLine(nDocID,0,"          who knows the recipe for ");
	Doc_PrintLine(nDocID,0,"                 the Mana elixir.");
	Doc_PrintLine(nDocID,0,"");
	Doc_Show(nDocID);
};


instance ITWR_EXHAUS_02(C_Item)
{
	name = "Recipe for the Extract of spirit recovery";
	mainflag = ITEM_KAT_DOCS;
	flags = 0;
	value = 1400;
	visual = "ItWr_Scroll_01_v4.3DS";
	material = MAT_LEATHER;
	on_state[0] = use_rezept_exhaus_02;
	scemeName = "MAP";
	description = name;
	text[5] = NAME_Value;
	count[5] = value;
...
func void use_rezept_exhaus_02()
{
	var int nDocID;
	if(Npc_IsPlayer(self))
	{
		if((KNOWS_EXHAUS_01 == TRUE) && (KNOWS_EXHAUS_02 == FALSE))
		{
			KNOWS_EXHAUS_02 = TRUE;
			Snd_Play("LevelUP");
			B_LogEntry(TOPIC_TalentAlchemy,"To prepare the Extract of spirit recovery, you need 3 black mushrooms,a miner's meat and 2 blue elders.");
		}
		else if(KNOWS_EXHAUS_02 == TRUE)
		{
			B_Say(hero,hero,"$BEZI_TO_WIE");
		}
		else
	...
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"   Creating");
	Doc_PrintLine(nDocID,0,"       the Extract of spirit recovery:");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"        x3 Black mushrooms");
	Doc_PrintLine(nDocID,0,"        x1 Digger's meat");
	Doc_PrintLine(nDocID,0,"        x2 Blue elders");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0," This potion can only be created by an alchemist");
	Doc_PrintLine(nDocID,0,"          who knows the recipe for ");
	Doc_PrintLine(nDocID,0,"                 the Essence of Spirit Recovery.");
...
instance ITWR_EXHAUS_03(C_Item)
{
	name = "Recipe for the Elixir of spirit recovery";
	mainflag = ITEM_KAT_DOCS;
	flags = 0;
	value = 2000;
	visual = "ItWr_Scroll_01_v4.3DS";
	material = MAT_LEATHER;
	on_state[0] = use_rezept_exhaus_03;
	scemeName = "MAP";
	description = name;
	text[5] = NAME_Value;
	count[5] = value;
...
func void use_rezept_exhaus_03()
{
	var int nDocID;
	if(Npc_IsPlayer(self))
	{
		if((KNOWS_EXHAUS_02 == TRUE) && (KNOWS_EXHAUS_03 == FALSE))
		{
			KNOWS_EXHAUS_03 = TRUE;
			Snd_Play("LevelUP");
			B_LogEntry(TOPIC_TalentAlchemy,"To prepare the Elixir of spirit recovery, you need 4 black mushrooms, 2 miner's meat and 3 blue elders.");
		}
		else if(KNOWS_EXHAUS_03 == TRUE)
		{
			B_Say(hero,hero,"$BEZI_TO_WIE");
		}
		else
	...
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"   Creating");
	Doc_PrintLine(nDocID,0,"       the Elixir of spirit recovery:");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0,"        x4 Black mushrooms");
	Doc_PrintLine(nDocID,0,"        x2 Digger's meats");
	Doc_PrintLine(nDocID,0,"        x3 Blue elders");
	Doc_PrintLine(nDocID,0,"");
	Doc_PrintLine(nDocID,0," This potion can only be created by an alchemist");
	Doc_PrintLine(nDocID,0,"          who knows the recipe for ");
	Doc_PrintLine(nDocID,0,"                 the Extract of Spirit Recovery.");
