...
{
	if((Npc_GetStateTime(self) > SPL_TIME_WHIRLWIND) || (((self.aivar[AIV_MM_REAL_ID] == ID_RAVEN) || (self.aivar[AIV_MM_REAL_ID] == ID_AMORT)) && (Npc_GetStateTime(self) > (SPL_TIME_WHIRLWIND / 3))))
	{
		B_StopWhirlwind();
		return LOOP_END;
	};
