...
func void B_AssessDamage()
{
	...
	if((Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Wache_01)) || (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Wache_02)))
	{
		if(Hlp_GetInstanceID(other) == Hlp_GetInstanceID(Fisk))
		{
			B_MagicHurtNpc(other,self,500);
		};
	};
