...
const int T_ULTRA = 300;
const int T_MEGA = 200;
const int T_MAX = 160;
...
var int dominiccurse;
var int dominicfree;
var int backstab;
var int addon_pring;
var int addon_tmplopn;
var int know_foreignlanguage;
...
var int cmpltbow_04;
var int cmpltbow_05;
var int cmplt1hsword_01;
var int cmplt1hsword_02;
var int cmplt1hsword_03;
var int cmplt1hsword_04;
var int cmplt1hsword_05;
var int cmplt2hsword_01;
var int cmplt2hsword_02;
var int cmplt2hsword_03;
var int cmplt2hsword_04;
var int cmplt2hsword_05;
var int cmplt1hspecsword_01;
var int cmplt1hspecsword_02;
var int cmplt1hspecsword_03;
var int cmplt1hspecsword_04;
var int cmplt1hspecsword_05;
var int cmplt2hspecsword_01;
var int cmplt2hspecsword_02;
var int cmplt2hspecsword_03;
var int cmplt2hspecsword_04;
var int cmplt2hspecsword_05;
var int cmpltharsh_01;
var int cmpltharsh_02;
var int cmpltharsh_03;
var int cmpltharsh_04;
var int cmpltharsh_05;
var int cmpltbensh_01;
var int cmpltbensh_02;
var int cmpltbensh_03;
var int cmpltbensh_04;
var int cmpltbensh_05;
var int sh_b_chance_15;
var int sh_b_chance_25;
var int sh_b_chance_35;
var int sh_b_chance_45;
var int sh_b_chance_55;
var int sh_b_chance_65;
var int sh_b_chance_75;
var int stat_sworddef;
var int stat_sworddef_max;
var int stat_hangr;
var int stat_thrst;
var int stat_ftque;
var int stat_exhst;
var int stat_actbns;
var int stat_wghtbns;
var int exhst_warn;
var int exhst_rest_60;
var int exhst_rest_100;
var int exhst_rest_120;
var int exhst_rest_140;
var int wispskill_level;
var int passive_acrobatic;
var int passive_acrobatic_on;
var int passive_hp;
...
var int bdt_armor_oldl_value;
var int bdt_armor_oldm_value;
var int bdt_armor_oldh_value;
...
var int ironmob_10_amount;
var int ironmob_11_amount;
var int ironmob_12_amount;
var int ironmob_13_amount;
var int ironmob_14_amount;
var int ironmob_15_amount;
var int ironmob_16_amount;
var int ironmob_17_amount;
var int ironmob_18_amount;
var int ironmob_19_amount;
var int ironmob_20_amount;
var int ironmob_21_amount;
var int ironmob_22_amount;
var int ironmob_23_amount;
var int ironmob_24_amount;
var int ironmob_25_amount;
var int ironmob_26_amount;
var int ironmob_27_amount;
var int ironmob_28_amount;
var int ironmob_29_amount;
var int ironmob_30_amount;
var int ironmob_31_amount;
var int ironmob_32_amount;
var int ironmob_33_amount;
var int ironmob_34_amount;
var int ironmob_35_amount;
var int ironmob_36_amount;
var int ironmob_37_amount;
var int ironmob_38_amount;
var int ironmob_39_amount;
var int ironmob_40_amount;
var int ironmob_41_amount;
var int ironmob_42_amount;
var int ironmob_43_amount;
var int ironmob_44_amount;
var int ironmob_45_amount;
var int ironmob_46_amount;
var int ironmob_47_amount;
var int ironmob_48_amount;
var int ironmob_49_amount;
var int ironmob_50_amount;
var int ironmob_51_amount;
var int ironmob_52_amount;
var int magicmob_01_amount;
var int magicmob_02_amount;
var int magicmob_03_amount;
var int magicmob_04_amount;
var int magicmob_05_amount;
var int magicmob_06_amount;
var int magicmob_07_amount;
var int magicmob_08_amount;
var int magicmob_09_amount;
var int magicmob_10_amount;
...
const int IRONMOB_01_AMOUNT_MAX = 1;
const int IRONMOB_02_AMOUNT_MAX = 1;
const int IRONMOB_03_AMOUNT_MAX = 1;
const int IRONMOB_04_AMOUNT_MAX = 1;
const int IRONMOB_05_AMOUNT_MAX = 1;
const int IRONMOB_06_AMOUNT_MAX = 1;
const int IRONMOB_07_AMOUNT_MAX = 1;
const int IRONMOB_08_AMOUNT_MAX = 1;
const int IRONMOB_09_AMOUNT_MAX = 1;
const int IRONMOB_10_AMOUNT_MAX = 1;
const int IRONMOB_11_AMOUNT_MAX = 1;
const int IRONMOB_12_AMOUNT_MAX = 1;
const int IRONMOB_13_AMOUNT_MAX = 1;
const int IRONMOB_14_AMOUNT_MAX = 1;
const int IRONMOB_15_AMOUNT_MAX = 1;
const int IRONMOB_16_AMOUNT_MAX = 1;
const int IRONMOB_17_AMOUNT_MAX = 1;
const int IRONMOB_18_AMOUNT_MAX = 1;
const int IRONMOB_19_AMOUNT_MAX = 1;
const int IRONMOB_20_AMOUNT_MAX = 1;
const int IRONMOB_21_AMOUNT_MAX = 1;
const int IRONMOB_22_AMOUNT_MAX = 1;
const int IRONMOB_23_AMOUNT_MAX = 1;
const int IRONMOB_24_AMOUNT_MAX = 1;
const int IRONMOB_25_AMOUNT_MAX = 1;
const int IRONMOB_26_AMOUNT_MAX = 1;
const int IRONMOB_27_AMOUNT_MAX = 1;
const int IRONMOB_28_AMOUNT_MAX = 1;
const int IRONMOB_29_AMOUNT_MAX = 1;
const int IRONMOB_30_AMOUNT_MAX = 1;
const int IRONMOB_31_AMOUNT_MAX = 1;
const int IRONMOB_32_AMOUNT_MAX = 1;
const int IRONMOB_33_AMOUNT_MAX = 1;
const int IRONMOB_34_AMOUNT_MAX = 1;
const int IRONMOB_35_AMOUNT_MAX = 1;
const int IRONMOB_36_AMOUNT_MAX = 1;
const int IRONMOB_37_AMOUNT_MAX = 1;
const int IRONMOB_38_AMOUNT_MAX = 1;
const int IRONMOB_39_AMOUNT_MAX = 1;
const int IRONMOB_40_AMOUNT_MAX = 1;
const int IRONMOB_41_AMOUNT_MAX = 1;
const int IRONMOB_42_AMOUNT_MAX = 1;
const int IRONMOB_43_AMOUNT_MAX = 1;
const int IRONMOB_44_AMOUNT_MAX = 1;
const int IRONMOB_45_AMOUNT_MAX = 1;
const int IRONMOB_46_AMOUNT_MAX = 1;
const int IRONMOB_47_AMOUNT_MAX = 1;
const int IRONMOB_48_AMOUNT_MAX = 1;
const int IRONMOB_49_AMOUNT_MAX = 1;
const int IRONMOB_50_AMOUNT_MAX = 1;
const int IRONMOB_51_AMOUNT_MAX = 1;
const int IRONMOB_52_AMOUNT_MAX = 1;
const int MAGICMOB_01_AMOUNT_MAX = 1;
const int MAGICMOB_02_AMOUNT_MAX = 1;
const int MAGICMOB_03_AMOUNT_MAX = 1;
const int MAGICMOB_04_AMOUNT_MAX = 1;
const int MAGICMOB_05_AMOUNT_MAX = 1;
const int MAGICMOB_06_AMOUNT_MAX = 1;
const int MAGICMOB_07_AMOUNT_MAX = 1;
const int MAGICMOB_08_AMOUNT_MAX = 1;
const int MAGICMOB_09_AMOUNT_MAX = 1;
const int MAGICMOB_10_AMOUNT_MAX = 1;
...
var int knows_battlemage;
var int knows_sldblackore;
var int knows_trollarcrft;
var int knows_sldg3;
var int knows_sldg3_grd1to3;
var int knows_sldg3_grd4to5;
var int knows_sldg3_grd6to7;
var int knows_w2knight;
var int knows_w2knight_grd1to2;
var int knows_w2knight_grd3to4;
var int knows_w2knight_grd5to7;
var int knows_mushroommp;
var int knows_exhaus_01;
var int knows_exhaus_02;
var int knows_exhaus_03;
var int knows_pdefmoss;
var int knows_bapehbe;
var int knows_1h_deathbringer;
var int knows_2h_deathbringer;
var int knows_smithmasterbook_lvl1;
var int knows_smithmasterbook_lvl2;
var int knows_smithmasterbook_lvl3;
...
var int constantino_heal;
var int constantino_heal_time;
var int constantino_mana;
var int constantino_mana_time;
var int Sonja_Says;
