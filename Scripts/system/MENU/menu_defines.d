...
const string MENU_BACK_PIC = "menu_back_new.tga";
...
const string MENU_SAVELOAD_BACK_PIC = "status_back_sl.tga";
const string LOG_BACK_PIC = "log_back.tga";
const string LOG_VIEWER_BACK_PIC = "log_paper.tga";
const string MENU_FONT_DEFAULT = "font_menu.tga";
const string MENU_FONT_SMALL = "font_log.tga";
const string MENU_FONT_BRIGHT = "font_menu_hi.tga";
const string LOG_FONT_DEFAULT = "font_log.tga";
const string LOG_FONT_VIEWER = "font_old_10_white.tga";
const string LOG_FONT_DATETIME = "font_log.tga";
