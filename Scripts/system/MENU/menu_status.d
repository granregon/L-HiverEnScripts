...
instance MENU_STATUS(C_MENU_DEF)
{
	...
	items[74] = "MENU_ITEM_PLAYERGUILD_INFO";
	dimx = 5192;
	dimy = 6192;
...
const int STAT_A_X0 = 2415;
const int STAT_A_X1 = 775;
...
instance MENU_ITEM_PLAYERGUILD_INFO(C_MENU_ITEM_DEF)
{
	posx = STAT_A_X1;
	posy = STAT_PLY_Y + (STAT_DY * 0);
	text[0] = "Guild";
...
instance MENU_ITEM_ARMOR_11_TITLE(C_MENU_ITEM_DEF)
{
	posx = STAT_A_X1;
...
instance MENU_ITEM_ARMOR_11(C_MENU_ITEM_DEF)
{
	posx = STAT_A_X2;
	posy = STAT_ARM_Y + (STAT_DY * 0);
	fontname = STAT_FONT_DEFAULT;
