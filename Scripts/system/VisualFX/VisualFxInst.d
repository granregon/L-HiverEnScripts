...
instance SPELLFX_THUNDERSTORM_FLASH_EXP(CFX_BASE_PROTO)
{
	emfxcreatedowntrj = 1;
	visname_s = "MFX_Thunderstorm_Flashes_Exp";
	emtrjmode_s = "FIXED";
	emtrjoriginnode = "ZS_RIGHTHAND";
	emfxcreate_s = "spellFX_ThunderStorm_Screenblend";
	sfxid = "MFX_Thunderstorm_Thunder";
...
instance SPELLFX_UNDEADSOUL(CFX_BASE_PROTO)
{
	visname_s = "PFX_BLESS_BONUS";
	emtrjmode_s = "FIXED";
	emtrjoriginnode = "BIP01";
};
...
instance SPELLFX_DEFSMOKE(CFX_BASE_PROTO)
{
	visname_s = "MFX_Defsmoke";
	emtrjmode_s = "FIXED";
	emtrjdynupdatedelay = 0.4;
	emtrjtargetrange = 1.2;
	emtrjtargetelev = 89;
...
instance SPELLFX_DRAGONFIREBALL(CFX_BASE_PROTO)
{
	visname_s = "MFX_Fireball_INIT";
	emtrjmode_s = "FIXED";
	emtrjoriginnode = "ZS_RIGHTHAND";
	...
	emactioncollstat_s = "COLLIDE CREATEONCE CREATEQUAD";
	emactioncolldyn_s = "COLLIDE CREATEONCE";
	emfxcollstat_s = "spellFX_DragonFireball_COLLIDE";
	emfxcolldyn_s = "spellFX_DragonFireball_COLLIDEDYNFX";
	emfxcolldynperc_s = "VOB_MAGICBURN";
	emfxcollstatalign_s = "COLLISIONNORMAL";
	emfxcreatedowntrj = 0;
	emtrjtargetrange = 20;
...
instance SPELLFX_DRAGONFIREBALL_KEY_OPEN(C_PARTICLEFXEMITKEY)
{
	lightrange = 0.01;
};

instance SPELLFX_DRAGONFIREBALL_KEY_INIT(C_PARTICLEFXEMITKEY)
{
	visname_s = "MFX_Fireball_INIT";
	lightrange = 0.01;
};

instance SPELLFX_DRAGONFIREBALL_KEY_CAST(C_PARTICLEFXEMITKEY)
{
	lightrange = 100;
	visname_s = "MFX_IFB_PFXTRAIL";
	emtrjmode_s = "TARGET";
	...
	sfxid = "MFX_Fireball_Cast";
	sfxisambient = 1;
	emcreatefxid = "spellFX_DragonFireball_FIRECLOUD";
	emcheckcollision = 1;
};

instance SPELLFX_DRAGONFIREBALL_KEY_COLLIDE(C_PARTICLEFXEMITKEY)
{
	pfx_flygravity_s = "0 0.0002 0";
	emtrjeasevel = 1e-006;
};

instance SPELLFX_DRAGONFIREBALL_FIRECLOUD(CFX_BASE_PROTO)
{
	emtrjeasevel = 1400;
	visname_s = "MFX_IFB_CAST";
	visalpha = 1;
...
instance SPELLFX_DRAGONFIREBALL_FIRECLOUD_KEY_COLLIDE(C_PARTICLEFXEMITKEY)
{
	emtrjeasevel = 1e-006;
};

instance SPELLFX_DRAGONFIREBALL_COLLIDE(CFX_BASE_PROTO)
{
	visname_s = "MFX_Fireball_Collide1";
	visalpha = 1;
	emtrjmode_s = "FIXED";
...
instance SPELLFX_DRAGONFIREBALL_COLLIDE_KEY_INVEST_1(C_PARTICLEFXEMITKEY)
{
	visname_s = "MFX_Fireball_Collide1";
	sfxid = "MFX_Fireball_Collide1";
};

instance SPELLFX_DRAGONFIREBALL_COLLIDEDYNFX(CFX_BASE_PROTO)
{
	visname_s = "MFX_Fireball_Collide1";
	visalpha = 1;
	emtrjoriginnode = "BIP01";
...
instance SPELLFX_DRAGONFIREBALL_COLLIDEDYNFX_KEY_INVEST_1(C_PARTICLEFXEMITKEY)
{
	visname_s = "MFX_Fireball_Collide1";
	sfxid = "MFX_Fireball_Collide1";
};
...
instance VOB_EVILBURN(CFX_BASE_PROTO)
{
	emtrjoriginnode = "BIP01 FIRE";
	visname_s = "MFX_MAGICFIRE_EVILBURN";
	emfxcreate_s = "VOB_EVILBURN_CHILD1";
	emfxcreatedowntrj = 1;
	emtrjmode_s = "FIXED";
	emtrjdynupdatedelay = 0;
	sfxid = "MFX_SUCKENERGY_CAST";
...
instance VOB_EVILBURN_CHILD1(CFX_BASE_PROTO)
{
	emtrjoriginnode = "BIP01 R UPPERARM";
	visname_s = "MFX_MAGICFIRE_EVILBURN";
	emfxcreate_s = "VOB_EVILBURN_CHILD2";
	emfxcreatedowntrj = 1;
	emtrjmode_s = "FIXED";
	emtrjdynupdatedelay = 0;
};

instance VOB_EVILBURN_CHILD2(CFX_BASE_PROTO)
{
	emtrjoriginnode = "BIP01 L UPPERARM";
	visname_s = "MFX_MAGICFIRE_EVILBURN";
	emfxcreate_s = "VOB_EVILBURN_CHILD3";
	emfxcreatedowntrj = 1;
	emtrjmode_s = "FIXED";
	emtrjdynupdatedelay = 0;
};

instance VOB_EVILBURN_CHILD3(CFX_BASE_PROTO)
{
	emtrjoriginnode = "BIP01 L HAND";
	visname_s = "MFX_MAGICFIRE_EVILBURN";
	emfxcreate_s = "VOB_EVILBURN_CHILD4";
	emfxcreatedowntrj = 1;
	emtrjmode_s = "FIXED";
	emtrjdynupdatedelay = 0;
};

instance VOB_EVILBURN_CHILD4(CFX_BASE_PROTO)
{
	emtrjoriginnode = "BIP01 R HAND";
	visname_s = "MFX_MAGICFIRE_EVILBURN";
	emfxcreate_s = "VOB_EVILBURN_CHILD5";
	emfxcreatedowntrj = 1;
	emtrjmode_s = "FIXED";
	emtrjdynupdatedelay = 0;
};

instance VOB_EVILBURN_CHILD5(CFX_BASE_PROTO)
{
	emtrjoriginnode = "BIP01 L FOOT";
	visname_s = "MFX_MAGICFIRE_EVILBURN";
	emfxcreate_s = "VOB_EVILBURN_CHILD6";
	emfxcreatedowntrj = 1;
	emtrjmode_s = "FIXED";
	emtrjdynupdatedelay = 0;
};

instance VOB_EVILBURN_CHILD6(CFX_BASE_PROTO)
{
	emtrjoriginnode = "BIP01 R FOOT";
	visname_s = "MFX_MAGICFIRE_EVILBURN";
	emtrjmode_s = "FIXED";
...
instance SWD_CASTBLEND(CFX_BASE_PROTO)
{
	visname_s = "screenblend.scx";
	userstring[0] = "0.5";
	userstring[1] = "10 160 0 100";
	userstring[2] = "0.5";
	emfxlifespan = 0.6;
};
...
instance START_BLEND(CFX_BASE_PROTO)
{
	visname_s = "screenblend.scx";
	userstring[0] = "100000000000";
	userstring[1] = "0 0 0 255";
...
instance PCDEAD_FX(CFX_BASE_PROTO)
{
	visname_s = "screenblend.scx";
	emfxcreate_s = "FOV_MORPH1";
	userstring[0] = "100000000000";
