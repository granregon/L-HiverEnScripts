...
instance SYS_MENU(C_MUSICTHEME)
{
	file = "Menu.sgt";
...
instance NSO_DAY_STD(C_MUSICTHEME_DEF)
{
	file = "cam_day_thr.sgt";
};

instance NSO_FGT_STD(C_MUSICTHEME_DEF)
{
	file = "cam_fgt_std.sgt";
};

instance NSO_NGT_STD(C_MUSICTHEME_DEF)
{
	file = "cam_day_thr.sgt";
};

instance LHF_DAY_STD(C_MUSICTHEME_DEF)
{
	file = "cam_day_thr.sgt";
};
...
instance NC_DAY_STD(C_MUSICTHEME_DEF)
{
...
instance NC_DAY_THR(C_MUSICTHEME_DEF)
{
	file = "nci_day_std.sgt";
	transtype = TRANSITION_TYPE_BREAK;
	transsubtype = TRANSITION_SUB_TYPE_MEASURE;
...
instance NC_DAY_FGT(C_MUSICTHEME_DEF)
{
...
instance NC_NGT_STD(C_MUSICTHEME_DEF)
{
	file = "nci_day_std.sgt";
};

instance NC_NGT_THR(C_MUSICTHEME_DEF)
{
	file = "nci_day_std.sgt";
};

instance NC_NGT_FGT(C_MUSICTHEME_DEF)
{
	file = "nci_day_fgt.sgt";
	transtype = TRANSITION_TYPE_FILL;
	transsubtype = TRANSITION_SUB_TYPE_MEASURE;
...
instance ORK_DAY_STD(C_MUSICTHEME_DEF)
{
...
instance SAL_DAY_STD(C_MUSICTHEME_STANDARD)
{
	file = "nosound.wav";
};

instance SAL_DAY_FGT(C_MUSICTHEME_FIGHT)
{
	file = "nosound.wav";
};
